...
import { Edit2, Trash2, UserPlus, Shield, X, Eye, EyeOff } from 'lucide-react';
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full pl-4 pr-12 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none ${errors.password ? 'border-red-500 bg-red-50' : 'border-gray-300 bg-white'}`}
                  autoComplete="new-password"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword((visible) => !visible)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-gray-400 hover:text-blue-600 focus:text-blue-600 focus:outline-none rounded"
